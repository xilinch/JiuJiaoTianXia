 ...
 * 升级对话框
 */
public class UpgradeChoiceDialog extends BaseUpgradeDailog {
    ...
    public UpgradeChoiceDialog(Activity context, UpgradeModel upgradeModel) {
        super(context, THEME);
    ...
    public UpgradeChoiceDialog(Activity context, boolean cancelable, DialogInterface.OnCancelListener cancelListener) {
        super(context, cancelable, cancelListener);
        this.activity = context;
        initView();
    }

    public UpgradeChoiceDialog(Activity context, int theme) {
        super(context, THEME);
        this.activity = context;
        initView();
    }
        ...
        dialog_upgrade_tv_upgrade_cp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (check()) {
                    ...
                    boolean isExist = checkAPKExist(upgradeModel);
                    if(isExist){
                         //直接安装
